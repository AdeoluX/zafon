...
exports.JoiRequestValidationError = exports.ErrorResponse = exports.ServerError = exports.FileTooLargeError = exports.NotAuthorizedError = exports.NotFoundError = exports.BadRequestError = exports.CustomError = void 0;
...
class ErrorResponse extends CustomError {
    constructor(message, statusCode = http_status_codes_1.default.BAD_REQUEST, stack = '') {
        super(message);
